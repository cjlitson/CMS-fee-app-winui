...
public interface IClfsService
{
    Task<IReadOnlyList<ClfsFee>> GetFeesAsync(int year, string? hcpcsCode = null, string? descriptionKeyword = null, CancellationToken cancellationToken = default);
